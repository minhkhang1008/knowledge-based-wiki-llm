...
export function AskIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M12 15v-.5a2 2 0 0 1 1.2-1.8 2.2 2.2 0 1 0-3-2.5" />
    </svg>
  );
}

export function ChunksIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function ConversationIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M20 4H4a1 1 0 0 0-1 1v14l4-3h13a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z" />
    </svg>
  );
}
