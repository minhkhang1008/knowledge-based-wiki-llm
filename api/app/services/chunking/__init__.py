...
import app.services.chunking.image_chunker  # noqa: F401 — đăng ký ảnh
import app.services.chunking.pdf_chunker  # noqa: F401 — đăng ký .pdf
...
from app.services.chunking.image_chunker import chunk_image
from app.services.chunking.pipeline import chunk_from_markdown, chunk_markdown_file
from app.services.chunking.pdf_chunker import chunk_pdf
